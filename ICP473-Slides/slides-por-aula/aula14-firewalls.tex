...
\begin{frame}{Introdução: Tipos de Firewalls}
    \begin{itemize}
        ...
        \item \textbf{Lógica de Filtragem (Implementa a Política):}
              \begin{itemize}
                  \item \textbf{Filtro Positivo (Positive Filter):} Permite passar \textit{apenas} os pacotes que atendem a critérios específicos. Ou seja possui um deny no fim.
                  \item \textbf{Filtro Negativo (Negative Filter):} Rejeita \textit{qualquer} pacote que atenda a certos critérios. Ou seja possui um allow no fim.
              \end{itemize}
