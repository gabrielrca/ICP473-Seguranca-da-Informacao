...
\begin{frame}{Problema de usar chave fixa no WEP}
    \begin{itemize}
        ...
        \item \textbf{Se utilizasse uma chave fixa}: todos os pacotes seriam criptografados com a mesma chave.
        \item Consequência: textos repetidos \textbf{gerariam} sempre a mesma saída.
    ...
    \begin{block}{Exemplo do Problema}
        \begin{itemize}
            ...
            \item Isso \textbf{revelaria} informação valiosa para o atacante.
        \end{itemize}
    \end{block}
\end{frame}
